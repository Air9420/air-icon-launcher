...
This project is indexed by GitNexus as **air-icon-launcher** (5608 symbols, 11427 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

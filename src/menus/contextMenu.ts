...
function buildBuiltinMenuModel(): MenuItem[] {
  const items: MenuItem[] = [
    ...
    {
      type: "item",
      id: "builtin:copy-clipboard-item-history",
      label: "复制到剪贴板",
      action: { kind: "copy-clipboard-item" },
      order: 62,
      visible: { menuType: enumContextMenuType.ClipboardHistoryView },
    },
    {
      type: "item",
      id: "builtin:locate-clipboard-item-in-history",
      label: "在剪贴板历史中定位",
      action: { kind: "locate-clipboard-item-in-history" },
      order: 63,
      visible: { menuType: enumContextMenuType.ClipboardHistoryView },
    },
    {
      type: "item",
      id: "builtin:delete-clipboard-item-history",
      label: "删除",
      action: { kind: "delete-clipboard-item" },
      order: 64,
      visible: { menuType: enumContextMenuType.ClipboardHistoryView },
    },
    {
